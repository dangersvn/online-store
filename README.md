...
## Cloudfoundary deployment:

    cf push -b https://github.com/cloudfoundry/java-buildpack.git -f .\deploy\cloudfoundry\manifest.yml -p .\build\libs\store-0.0.1-SNAPSHOT.jar
